...
比对:  ① 冻结短语(F类, dedup-baseline-vol3.md) 逐字匹配
       ...
       ⑨ F10 章题声明与旧题禁引 (自 ch141 起): 新章题必须先声明于卷纲(outline-vol7.md 管 141-164, outline-vol8.md 管 165-188, outline-vol9.md 管 189-212, outline-vol10.md 管 213-236, outline-vol11.md 管 237-260, outline-vol12.md 管 261-284, 随卷演进);
       ...
       ⑳ F26 段落体例 (源: 2026-09-14 段落碎片化治理——卷十—十二均段跌回开卷水平):
          ...
          **已归治章段**(F26_TREATED=卷一二 ch1—44 + 卷十一二 ch219—284 + 2026-09-17 第三轮单章并入 ch71/88/116/184—188/204/207—208/210/212 + 2026-09-23 第四轮并入卷十三—十四 ch285—332),
...
# === F15·卷十一回收链机械校验 (ch237-260, 与 outline-vol11 章眼同步) ===
VOL11_REQ = {
    237: [["换榜"], ["极危名录"]], 238: [["拟名"], ["行军簿"]], 239: [["过河"], ["陆沉舟"]],
    240: [["换盐"], ["崔玉真"]], 241: [["军令"], ["簿外页"]], 242: [["断粮"], ["民夫"]],
    243: [["旧枪"], ["萧寒山"]], 244: [["三王"], ["黑榜"]], 245: [["侧令"], ["断后"]],
    246: [["撤民"], ["伤民"]], 247: [["名单"], ["簿外页"]], 248: [["死者"], ["逃兵"]],
    249: [["强征"], ["十万民夫"]], 250: [["收伤"], ["石梁寺"]], 251: [["救人"], ["药案"]],
    252: [["断后"], ["拓跋赤德"]], 253: [["合页"], ["合读"]], 254: [["分拆"], ["原件"]],
    255: [["无罪"], ["虞凤池"]], 256: [["归册"], ["三千"]], 257: [["换河"], ["谢听潮"]],
    258: [["不赦"], ["不可原谅", "知过"]], 259: [["河声"], ["追缉"]], 260: [["北望"], ["民夫名单"]],
}
# === F15·卷十二回收链机械校验 (ch261-284, 与 outline-vol12 第五章节拍同步) ===
# 每章至少命中任一组 token 之一, 防止写 ch261-284 时漏掉章眼意象。
# 维护约定: 改 outline-vol12 章眼或 foreshadowing 卷十二预登记区, 必须先同步本表。
VOL12_REQ = {
    261: [["极危名录"], ["军籍"]], 262: [["顶名"], ["按榜验人"]], 263: [["皮囊目录"], ["开封地址"]],
    264: [["药队"], ["照写"]], 265: [["说书"], ["四十年"]], 266: [["两头卖"], ["卖给两方"]],
    267: [["两册对照"], ["公孙白"]], 268: [["未核"], ["回执"]], 269: [["改过一两个字"], ["抄本"]],
    270: [["夹注"], ["观天台旧吏"]], 271: [["结局册"], ["失控", "疯癫", "自尽"]], 272: [["编进书里"], ["守望者"]],
    273: [["抄一份送京"], ["附录"]], 274: [["拦下"], ["记危"]], 275: [["算极"], ["旧列第二"]],
    276: [["毁掉一页"], ["密码本"]], 277: [["抢"], ["拟名抄件"]], 278: [["凭据"], ["可复制"]],
...
# === F15·卷十四回收链机械校验 (ch309-332, 与 outline-vol14 第五章节拍同步) ===
# 卷十四开写前补齐第一批章眼，后续章眼按正文推进逐步补全。
VOL14_REQ = {
    309: [["新帝"], ["裁走", "南卫"], ["回纥", "要钱"]],
    310: [["廷议"], ["吐血"], ["离府"]],
    311: [["交权"], ["朱烈"], ["阿史那朵"]],
...
F26_TREATED = [(1, 44), (71, 71), (88, 88), (116, 116), (184, 188), (204, 204), (207, 208), (210, 210), (212, 212), (219, 284), (285, 332)]  # 2026-09-17 第三轮单章并入；2026-09-23 第四轮并入卷十三—十四 ch285—332（48/48 达标后入册，棘轮只增不减）
    ...
    for n in args:
        ...
        if n < 141:
            ...
            decl_file = ("outline-vol7.md" if n <= 164 else ("outline-vol8.md" if n <= 188
                         ...
                         else ("outline-vol11.md" if n <= 260 else ("outline-vol12.md" if n <= 284 else ("outline-vol13.md" if n <= 308 else "outline-vol14.md")))))))
        ...
        req_tbl = (VOL14_REQ if 309 <= n <= 332 else
                   (VOL13_REQ if 285 <= n <= 308 else
